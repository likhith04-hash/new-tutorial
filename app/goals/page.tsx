    ...
    <>
      ...
      <div className="goals-page">
        ...
        <div className="goal-cards">
          ...
          <div className="goal-card">
            <div className="goal-header"><label>Protein</label><span>{todayMacros.protein}g / {local.proteinG}g</span></div>
            ...
            <input type="number" className="goal-input" value={local.proteinG} onChange={e => setField('proteinG', +e.target.value)} onBlur={handleSave} />
          </div>
          <div className="goal-card">
            <div className="goal-header"><label>Carbs</label><span>{todayMacros.carbs}g / {local.carbsG}g</span></div>
            ...
            <input type="number" className="goal-input" value={local.carbsG} onChange={e => setField('carbsG', +e.target.value)} onBlur={handleSave} />
          </div>
          <div className="goal-card">
            <div className="goal-header"><label>Fat</label><span>{todayMacros.fat}g / {local.fatG}g</span></div>
            <div className="goal-ring-wrap"><MacroRing value={todayMacros.fat} total={local.fatG} label="Fat" color="var(--clr-fat)" size={80} /></div>
            <input type="number" className="goal-input" value={local.fatG} onChange={e => setField('fatG', +e.target.value)} onBlur={handleSave} />
          </div>
          <div className="goal-card">
            <div className="goal-header"><label>Water</label><span>{local.waterGlasses} glasses / day</span></div>
            <div className="goal-ring-wrap" style={{ padding: '10px 0' }}><Icon name="water" size={36} /></div>
            <input type="number" className="goal-input" value={local.waterGlasses} onChange={e => setField('waterGlasses', +e.target.value)} onBlur={handleSave} />
          </div>
        </div>
